...
class RoundedButton extends Component {
	...
	public void paint(Graphics g) {
		...
		g.setColor(getBackground().darker().darker().darker().darker().darker()
				.darker().darker().darker().darker().darker().darker().darker()
	...
	public Dimension getPreferredSize() {
		...
		if (f != null) {
			FontMetrics fm = getFontMetrics(getFont());
			int max = Math
					.max(fm.stringWidth(label) + 60, fm.getHeight() + 100);
